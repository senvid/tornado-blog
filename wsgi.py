...
'''
define("mysql_host", default="maria.xxx.com:3066", help="blog database host")
define("mysql_database", default="xxxx", help="blog database name")
define("mysql_user", default="xxxx", help="blog database user")
define("mysql_password", default="xxxx", help="blog database password")
'''
